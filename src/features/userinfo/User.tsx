...
const User = () => {
    return (
        <Grid justifyContent="center" style={{
            marginTop: 50
        }} container md={12} sm={12} direction="row">
            ...
            <Grid justifyContent="center" style={{
                ...
                <Grid container direction="column" style={{
                    ...
                    <Grid item>
                        <Typography variant="h5" component="h5">Priyadarshan Singh</Typography>
                    </Grid>
